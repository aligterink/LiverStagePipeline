...
# class Extractor:
#     def __init__(self, intensity_image, name, parasite_mask=None, hepatocyte_mask=None, merozoite_mask=None):
...
#         intensity_crop = intensity_image[cell_bbox[1]:cell_bbox[3], cell_bbox[0]:cell_bbox[2]]

#         if label == 9:
#             from segmentation.merozoite_watershed import segment_cell
#             segment_cell(np.pad(intensity_crop, mode='minimum', pad_width=2))
